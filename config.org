...
** Default initial buffer to notes.org file

#+BEGIN_SRC emacs-lisp
(setq initial-buffer-choice "~/.emacs.d/emacs-sync/org/notes.org")
...
(global-set-key (kbd "C-w") 'my/kill-word-at-point)
(global-set-key (kbd "C-c c") 'my/org-capture-task)
(global-set-key (kbd "C-c C-c") 'my/org-capture-task)
#+END_SRC
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(setq org-default-notes-file  "~/.emacs.d/emacs-sync/org/notes.org")
#+END_SRC
