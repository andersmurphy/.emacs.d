...
(defun my/clj-try-to-open-project-project-file (&optional clj-lisp-prog)
  (or (ignore-errors
...
(defun my/clj-open-repl (&optional clj-lisp-prog)
  ...
  (if (one-window-p)
      (progn (split-window-right)
             (other-window 1)
             (my/clj-try-to-open-project-project-file clj-lisp-prog)
             (inferior-lisp inferior-lisp-program))
    (progn (display-buffer-use-some-window (current-buffer) nil)
           (other-window 1)
           (my/clj-try-to-open-project-project-file clj-lisp-prog)
           (inferior-lisp inferior-lisp-program)))
