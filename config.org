...
(defun enable-repl-pprint ()
 (interactive)
 (lisp-eval-string
  (format "%s" '(clojure.main/repl :print clojure.pprint/pprint))))
...
(defun doc-for-symbol ()
  (interactive)
  (lisp-eval-string (format "(clojure.repl/doc %s)" (symbol-at-point))))

(defun source-for-symbol ()
  (interactive)
  (lisp-eval-string (format "(clojure.repl/source %s)" (symbol-at-point))))

(defun refresh-repl ()
  (interactive)
  (lisp-eval-string "(clojure.tools.namespace.repl/refresh)"))
