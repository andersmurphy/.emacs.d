...
(global-set-key (kbd "C-w") 'topiary/smart-kill)
(global-set-key (kbd "C-t") 'topiary/smart-transpose)
(global-set-key (kbd "M-c") 'org-capture)
(global-set-key (kbd "C-v") 'yank)
(global-set-key (kbd "C-o") 'other-window)
(global-set-key (kbd "'") 'topiary/smart-quote)
(global-set-key (kbd "C-f") 'topiary/skip-ws-forward-char)
(global-set-key (kbd "C-b") 'topiary/skip-ws-backward-char)
...
#+BEGIN_SRC emacs-lisp
(global-set-key (kbd "C-a") 'topiary/back-to-indentation-or-beginning)
#+END_SRC
* Navigation
** Recent files
