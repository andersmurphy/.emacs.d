...
[[https://github.com/clojure-emacs/inf-clojure][Inf-clojure]] a minimalist repl integration. Configured to use a socket repl.
...
(use-package inf-clojure
  ...
  :bind (:map inf-clojure-minor-mode-map
          ("C-c C-t" . inf-clojure-run-tests-in-namespace)
          ("C-c C-z" . inf-clojure-open-repl-without-switching-buffer)))
#+END_SRC

Send (run-tests) to running clojure repl.

#+BEGIN_SRC emacs-lisp
(defun inf-clojure-run-tests-in-namespace ()
  (interactive)
  (comint-redirect-send-command-to-process "(run-tests)"
                                           "*inf-clojure*"
                                           "*inf-clojure*"
                                           "*inf-clojure*"))
#+END_SRC

Don't switch to repl buffer when opening/toggling.

#+BEGIN_SRC emacs-lisp
(defun inf-clojure-open-repl-without-switching-buffer ()
  (interactive)
