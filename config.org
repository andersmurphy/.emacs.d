...
(use-package doom-themes
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-keyword-face ((t (:foreground ,(doom-color 'violet)))))
   `(font-lock-variable-name-face ((t (:foreground ,(doom-color 'blue)))))
   `(font-lock-function-name-face ((t (:foreground ,(doom-color 'blue)))))
   `(font-lock-constant-face ((t (:foreground ,(doom-color 'cyan)))))
   `(font-lock-builtin-face ((t (:foreground ,(doom-color 'cyan)))))
