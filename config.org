...
[[https://github.com/syl20bnr/evil-escape][Evil Escape]] is a customisable key sequence to escape from insert state and
everything else in Emacs. By default it is set to fd.
