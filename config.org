...
[[doom-spacegrey][Doom]] themes. To find out the name of the face you want to customise: M-x customize-face and then search through the list of faces.
...
(use-package doom-themes
  ...
  (defun my/customise-theme ()
    (doom-themes-set-faces
      ...
      '(show-paren-match :foreground magenta)
      '(show-paren-match-expression :background region)
...
Shows matching paren and highlights sexp.
...
(add-hook 'post-command-hook 'my/hl-current-symbol-hook)
#+END_SRC
