...
(defhydra hydra-test (:foreign-keys warn)
  "Test"
  ("a" ruby-test-run "run all test in file" :exit t)
  ("r" ruby-test-run-at-point "run test at pointer" :exit t)
  ("s" ruby-test-toggle-implementation-and-specification "switch between test and implementation")
  ("q" nil "quit")
)
#+END_SRC
...
[[https://github.com/r0man/ruby-test-mode][Ruby-test-mode]] is a  minor mode for Behaviour and Test Driven Development
in Ruby.
...
When ruby-test-mode finishes tests, automatically jump to the test buffer
