...
(use-package doom-themes
  ...
  (custom-theme-set-faces
   my/theme
   `(org-level-1 ((t (:height 1.2 :weight ultra-bold :forground ,(doom-color 'blue)))))
   `(org-level-2 ((t (:height 1.0 :weight bold :forground ,(doom-color 'magenta)))))
  ...
  (cond
   ...
   ((file-exists-p (concat dirname "deps.edn"))
    (list (concat dirname "deps.edn")
          "clojure"))
   ((my/dir-contains-git-root-p dirname)
    (list (buffer-file-name) "clojure"))
   ((string= "" dirname)
    (list (buffer-file-name) "clojure"))
   (t (my/try-to-find-project-file
       (file-name-directory
