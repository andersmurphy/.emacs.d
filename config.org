...
*** Auto tangle osx-setup.org on save

#+BEGIN_SRC emacs-lisp
(defun my/tangle-osx-setup ()
  (when (equal (buffer-file-name)
               (expand-file-name "~/.emacs.d/osx-setup.org"))
    (org-babel-tangle-file "~/.emacs.d/osx-setup.org")))

(add-hook 'after-save-hook #'my/tangle-osx-setup)
#+END_SRC
